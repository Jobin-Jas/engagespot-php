...
$replacements = [
    'jobin\\\\engagespot\\\\' => function () use(&$values) { return str_replace('\\', '\\\\', $values['psr4_namespace']) . '\\\\'; },
    'Jobin Jose'                 => function () use(&$values) { return $values['author_name']; },
    'Jobin-Jas'             => function () use(&$values) { return $values['author_github_username']; },
    ':author_website'              => function () use(&$values) { return $values['author_website'] ?: ('https://github.com/' . $values['author_github_username']); },
    'jobin8157@gmail.com'                => function () use(&$values) { return $values['author_email'] ?: ($values['author_github_username'] . '@example.com'); },
    'jobin'                      => function () use(&$values) { return $values['package_vendor']; },
    'engagespot'                => function () use(&$values) { return $values['package_name']; },
    'engagespot php package'         => function () use(&$values) { return $values['package_description']; },
